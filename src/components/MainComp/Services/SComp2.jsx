...
export default function SComp2() {
    return (
        <>
            <h2 class="mb-1 text-3xl font-extrabold text-center text-gray-900 urbanist dark-mode-fonts-bold dark-mode-fonts">Services</h2>
            <p class="mb-12 text-lg text-gray-500 comfortaa text-center dark-mode-fonts-light">Here is a few of the awesome Services we provide.</p>

            <div class="-mx-4 flex flex-wrap p-8">

                <div class="w-full px-4 md:w-1/2 lg:w-1/3 ">
                    <div class="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9 testii testii">
                        ...
                        <div>
                            <h3 class="mb-4 text-xl font-bold text-black sm:text-2xl lg:text-xl xl:text-2xl urbanist dark-mode-fonts ">Free to Get Started
                            </h3>
                            <p class="text-base font-medium text-body-color comfortaa">FormBold is free to use, we are offering a decent free
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                    <div class="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9 testii">
