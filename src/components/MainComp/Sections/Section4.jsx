...
export default function Section4() {
    return (
        <div className="relative border-white section4">
            <img
                ...
                <div className="relative px-4 py-16 mx-auto overflow-hidden sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                    <div className="flex flex-col items-center justify-between xl:flex-row">
                        <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
                            <h2 className="max-w-lg mb-6 text-3xl font-bold tracking-tight text-white sm:text-4xl sm:leading-none raleway-bold">
                                Get your eyes on our brand new affordable offers !! <br className="hidden md:block" />

                            </h2>
                            <p className="max-w-xl mb-4 text-base text-gray-200 md:text-lg comfortaa">
                        ...
                        <div className="w-full max-w-xl xl:px-8 xl:w-5/12  qoute">
                            <div class="card">
                                <div class="card-name">Check Out</div>
                                <div class="quote">
                                ...
                                <div class="body-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione tempora rerum.</div>
