...
export default function CComp2() {
  return (
    <div class="max-w-6xl mx-auto bg-white my-24 font-[sans-serif] text-[#011c2b] contact-section">
            <div class="text-center px-6">
                <h2 class="text-3xl font-extrabold urbanist">Contact Us</h2>
                <p class="text-sm text-gray-400 mt-3 comfortaa">Have some big idea or brand to develop and need help?</p>
            </div>
            <div class="grid lg:grid-cols-3 items-center gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-8 contact-form">
                <div class="bg-[#011c2b] rounded-lg p-6 max-lg:text-center">
                    <h2 class="text-xl font-bold text-white urbanist">Contact Information</h2>
                    <p class="text-sm text-gray-400 mt-3 comfortaa">Have some big idea or brand to develop and need help?</p>
                    <ul class="mt-16 space-y-10">
                        <li class="flex items-center max-lg:justify-center">
                            ...
                            <a href="javascript:void(0)" class="text-white text-sm ml-3 raleway">
                ...
                <div class="p-6 rounded-xl lg:col-span-2 ">
                    <form>
                        <div class="grid sm:grid-cols-2 gap-8 raleway">
                            <div class="relative flex items-center raleway">
                                <input type="text" placeholder="First Name"
                                    class="px-2 py-3 bg-white w-full text-sm border-b-2 text-black focus:border-[#011c2b] outline-none" />
                                <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" class="w-[18px] h-[18px] absolute raleway right-2"
                                    viewBox="0 0 24 24">
                            ...
                            <div class="relative flex items-center raleway">
                                <input type="text" placeholder="Last Name"
                                    class="px-2 py-3 bg-white w-full text-sm border-b-2 text-black focus:border-[#011c2b] outline-none raleway" />
                            ...
                            <div class="relative flex items-center">
                                <input type="number" placeholder="Phone No."
                                    class="px-2 py-3 bg-white text-black w-full text-sm border-b-2 focus:border-[#011c2b] outline-none raleway" />
                        ...
                        <button type="button"
                            class=" urbanist mt-12 flex items-center justify-center text-sm lg:ml-auto max-lg:w-full rounded px-4 py-2.5 font-semibold bg-[#011c2b] text-white hover:bg-[#011c2bf3]">
